...
:: Android packaging
set AND_CERT_NAME="SQLiteMobile"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\SQLiteMobile.p12
...
set IOS_PROVISION=cert\SQLiteMobile.mobileprovision
...
set APP_ID=jp.mztm.SQLiteMobile

:: Output packages
set DIST_PATH=dist
set DIST_NAME=SQLiteMobile
